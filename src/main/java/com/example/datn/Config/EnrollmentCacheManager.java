 ...
 * Spring Cache dùng AOP Proxy. Nếu @CacheEvict được gọi từ bên trong cùng một
 * class (self-invocation),
 * Spring sẽ KHÔNG đi qua proxy → @CacheEvict bị bỏ qua hoàn toàn (silent
 * failure).
...
public class EnrollmentCacheManager {
     ...
     * Gọi sau khi enroll() hoặc cancelEnrollment() để đảm bảo lần đọc tiếp theo lấy
     * dữ liệu mới.
     *
